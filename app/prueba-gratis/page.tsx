          ...
          <div className="space-y-8">
            <div>
              <h1 className="text-3xl md:text-4xl lg:text-5xl font-bold text-gray-900 leading-tight">
                ...
                <span className="text-blue-600">prueba gratuita.</span>
              </h1>
            </div>
            ...
            <div className="space-y-4">
              ...
              <div className="flex items-center text-gray-700">
                ...
                <span>La prueba gratis no incluye la emisión de facturas electrónicas.</span>
              </div>
            </div>
            ...
            <div className="bg-blue-600 text-white rounded-lg p-6">
              <div className="flex flex-col sm:flex-row items-center justify-between space-y-4 sm:space-y-0">
                ...
                <div className="flex items-center space-x-2 sm:space-x-4">
                  ...
                  <span className="text-sm text-center sm:text-left">Revisa tu correo para activar tu usuario</span>
                </div>
                ...
                <div className="flex items-center space-x-2 sm:space-x-4">
                  ...
                  <span className="text-sm">¡Listo! ya puedes usar Invy</span>
                </div>
              </div>
            </div>
          ...
          <div className="bg-white rounded-2xl shadow-xl p-8">
            <div className="text-center mb-8">
              ...
              <p className="text-gray-600">
                Completa el formulario para acceder a tu prueba gratuita
              </p>
            </div>
            ...
            <form onSubmit={handleSubmit} className="space-y-6">
              ...
              <div className="text-sm text-gray-600 bg-gray-50 p-4 rounded-lg">
                <p className="mb-2"><strong>Preguntas frecuentes</strong></p>
                <div className="space-y-1">
                  <p>• ¿Es realmente gratis? Sí, 30 días completamente gratis</p>
                  <p>• ¿Necesito tarjeta de crédito? No, solo tus datos básicos</p>
                  <p>• ¿Puedo cancelar cuando quiera? Sí, sin compromisos</p>
                </div>
              </div>
...
export default PruebaGratisPage; 